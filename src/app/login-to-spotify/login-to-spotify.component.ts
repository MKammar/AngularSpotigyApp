...
export class LoginToSpotifyComponent  {
  ...
  loginRedirect = function () {
      window.location.href = `${LoginToSpotifyComponent.Spotify_Authorize_Endpoint}?client_id=${LoginToSpotifyComponent.Client_ID}&response_type=token&redirect_uri=${LoginToSpotifyComponent.Redirect_URl}&scope=${LoginToSpotifyComponent.Scopes_Param}`;
    }
